			...
			$.ajax({
				...
				success: function(result){
					...
					if(result == 1){
						...
						$('#checkType').attr('class','modal-content panel-success');//success색깔의 알림창을 띄움
					}else{
						$('#checkMessage').html('사용할 수 없는 아이디 입니다.');
						$('#checkType').attr('class','modal-content panel-warning');//warnig색깔의 알림창을 띄움
					}
...
<body>
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp">모두나눔</a>
		</div>
	...
	<div class="container">
		<form method="post" action="./userRegister">
			...
			<div class="container_wrap" style="height:490px;">
				<div class="container_wrap_left">
					<p id="previewId0" class="fileViewClass"><img id="oriImg" alt="프로필사진" src="images/icon.png" width=50px;></p>
				</div>
					...
					<tbody>
						<tr>
							...
							<td style="width:110px;">
								<button class="btn btn-primary" id="ddch" 
						...
						<tr>
							...
							<td colspan="2">
								...
								type="password" name="userPassword1" id="userPassword1" maxlength="20" 
						...
						<tr>
							...
							<td colspan="2">
								<input onkeyup="passwordCheckFunction();" class="form-control" 
								type="password" name="userPassword2" id="userPassword2" maxlength="20" 
								placeholder="비밀번호 확인"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="2">
								...
								id="userAge" maxlength="20" placeholder="나이를 입력하세요"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="2">
								...
								id="userEmail" maxlength="20" placeholder="이메일을 입력하세요"/>
							</td>
						</tr>
						<tr>
