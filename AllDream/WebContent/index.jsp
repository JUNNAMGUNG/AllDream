...
<script>
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp">모두 나눔</a>
		</div>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align:center;border:1px solid #ddd">
			<thead>
				<tr>
					<th colspan="3"><h4>모두 나눔 메인페이지</h4></th>
				</tr>
			</thead>
		<% if(userID != null){ %>
			<tbody>
				<tr><td><div id="contents"></div></td></tr>
			</tbody>
		<% }else{ %>
			<tbody>
				<tr><td>로그인을 하여야 게시글을 볼 수 있습니다.</td></tr>
			</tbody>
